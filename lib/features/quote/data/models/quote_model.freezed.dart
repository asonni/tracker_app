...
mixin _$QuoteModel {
 ...
 String? get id; String? get quote; String? get author;
...
@useResult
$Res call({
 String? id, String? quote, String? author
});
...
/// Create a copy of QuoteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? quote = freezed,Object? author = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? quote,  String? author)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuoteModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? quote,  String? author)  $default,) {final _that = this;
switch (_that) {
case _QuoteModel():
return $default(_that.id,_that.quote,_that.author);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? quote,  String? author)?  $default,) {final _that = this;
switch (_that) {
case _QuoteModel() when $default != null:
return $default(_that.id,_that.quote,_that.author);case _:
  return null;
...
class _QuoteModel implements QuoteModel {
  const _QuoteModel({this.id, this.quote, this.author});
...
/// Create a copy of QuoteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? quote = freezed,Object? author = freezed,}) {
