...
class SharedProfileScreen extends StatelessWidget {
  ...
  const SharedProfileScreen({super.key, required this.profileData});

  @override
  Widget build(BuildContext context) {
    debugPrint('Building SharedProfileScreen');
    debugPrint('Received profile data: $profileData');
    debugPrint('Number of parameters: ${profileData.length}');
    profileData.forEach((key, value) {
      debugPrint('Parameter - $key: $value');
    });
